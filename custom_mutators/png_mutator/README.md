...
Исследование проводилось в тестовом режиме: тестовая программа сначала сжимает изображение, а затем распаковывает вывод fpng с помощью `lodepng`, `stb_image` и декодера fpng для проверки сжатых данных.
